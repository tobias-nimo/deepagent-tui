...
def render_tool_result(result: FormattedToolResult) -> None:
    ...
    from deepagent_tui.ui.tool_widgets import render_tool_result_widget
    ...
    if not result.is_error and result.content:
        from deepagent_tui.utils.images import detect_image_paths
...
def render_image(path: str) -> None:
    ...
    from deepagent_tui.utils.images import can_render_inline, write_inline_image
